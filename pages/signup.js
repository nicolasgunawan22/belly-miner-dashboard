...
function Signup({ userData }) {
   ...
   async function handleOnSubmit(e) {
      ...
      try {
         setIsLoading(true)
         const response = await axios.post("https://bellyminer-server.herokuapp.com/api/user/register", formData, { crossdomain: true });
         router.replace("/login");
      } catch (err) {
         setError(true)
         setIsLoading(false)
      ...
      return (
         <>
            ...
            <div className="flex justify-center items-center h-screen w-screen bg-gradient-to-r from-indigo-500 to-fuchsia-600">
               <div className={`${isVisible ? "inline-block" : "hidden"} fixed top-0w-full h-1`}>
                     ...
                     <form className="flex flex-col justify-center h-full space-y-6" onSubmit={handleOnSubmit}>
                        ...
                        <div className="flex gap-2">
                           <div>
                              ...
                              <input onChange={handleOnChange} type="text" name="firstName" id="firstName" className="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-500 dark:placeholder-neutral-400 dark:text-white" placeholder="John" required />
                           </div>
                           <div>
                              ...
                              <input onChange={handleOnChange} type="text" name="lastName" id="lastName" className="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-500 dark:placeholder-neutral-400 dark:text-white" placeholder="Doe" required />
                           </div>
                        </div>
                        <div>
                           ...
                           <input onChange={handleOnChange} type="text" name="username" id="username" className="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-500 dark:placeholder-neutral-400 dark:text-white" placeholder="johndoe" required />
                        </div>
                        <div>
                           <label htmlFor="email" className="block mb-1 text-sm font-medium text-neutral-900 dark:text-neutral-300">Your email</label>
                           <input onChange={handleOnChange} type="email" name="email" id="email" className="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-500 dark:placeholder-neutral-400 dark:text-white" placeholder="name@company.com" required />
                        </div>
                        <div>
                           ...
                           <input onChange={handleOnChange} type="password" name="password" id="password" placeholder="••••••••" className="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-500 dark:placeholder-neutral-400 dark:text-white" required />
                        </div>
                        <div>
                           ...
                           <input onChange={handleOnChange} type="text" name="walletAddress" id="walletAddress" className="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-neutral-600 dark:border-neutral-500 dark:placeholder-neutral-400 dark:text-white" placeholder="0x0000000000000000000000000000000000000000" required />
                        </div>
                        <button
