         ...
         <AreaChart data={convertedData}>
            <defs>
               <linearGradient id="colorUv" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#2937f0" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="#2937f0" stopOpacity={0} />
               </linearGradient>
            ...
            <Tooltip />
            <Area type="monotone" dataKey="Hashrate" stroke="#2937f0" fillOpacity={1} fill="url(#colorUv)" />
         </AreaChart>
      </ResponsiveContainer>
   )
